...
<?php
/**
 * AiezFind — 獨立測試用 MQTT 訂閱守護程序 (固定連線 10.2.6.202)
 *
 * 執行方式：
 *   php daemon/mqtt_daemon1.php
 */
...
logMsg('INFO', '=== AiezFind MQTT Daemon (外部設備版) 啟動 ===');

// 強制寫死外部主機的設定，不從資料庫讀取，確保獨立運行
$mqttHost = '10.2.6.202';
$mqttPort = 1883;
$mqttUser = 'btciot';
$mqttPass = 'tiger?iot';
...
// 避免底線等特殊符號造成 unauthorized 錯誤
$clientId = 'daemonExt' . rand(1000, 9999);
